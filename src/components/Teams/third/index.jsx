...
const Third = ({ third }) => {
  ...
  const visiblePhotos = third.slice(currentIndex, currentIndex + 4);
  const totalPages = Math.ceil(third.length / 4); // Calculate the total number of pages
  ...
  return (
    <div className="container">
      <div className="text-container">
        ...
        <button disabled="disabled">Year-3rd</button>
      </div>
      <div className="photo-container">
        ...
        <div className="radio-buttons">
          {[...Array(Math.ceil(third.length / 4))].map((_, index) => (
            <label key={index}>
              <input
                type="radio"
                name="team-radio"
